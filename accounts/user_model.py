...
from .db_utils import (
    ...
    check_username_exists, check_email_exists, get_all_users
)
import re
import json
...
class User:
    ...
    def save(self, *args, **kwargs):
        ...
        # Sync is_staff and is_superuser with role
        if self.role == 'admin':
            self.is_staff = True
